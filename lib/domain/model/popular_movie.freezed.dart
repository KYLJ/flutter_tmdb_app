...
class _$PopularMovieImpl implements _PopularMovie {
  ...
  factory _$PopularMovieImpl.fromJson(Map<String, dynamic> json) =>
      _$$PopularMovieImplFromJson(json);
  ...
  @override
  String toString() {
    return 'PopularMovie(adult: $adult, backdropPath: $backdropPath, genreIds: $genreIds, id: $id, originalLanguage: $originalLanguage, originalTitle: $originalTitle, overview: $overview, popularity: $popularity, posterPath: $posterPath, releaseDate: $releaseDate, title: $title, video: $video, voteAverage: $voteAverage, voteCount: $voteCount)';
  }
  ...
  Map<String, dynamic> toJson() {
    return _$$PopularMovieImplToJson(
      this,
    );
  }
}
...
abstract class _PopularMovie implements PopularMovie {
  const factory _PopularMovie(
      ...
      required final num voteCount}) = _$PopularMovieImpl;

  factory _PopularMovie.fromJson(Map<String, dynamic> json) =
      _$PopularMovieImpl.fromJson;
